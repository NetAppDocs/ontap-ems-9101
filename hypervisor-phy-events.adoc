...
[.lead]
hypervisor.phy EMS events occur when ONTAP encounters issues associated with the physical network interface configuration on the hypervisor for ONTAP(R) Select support.
