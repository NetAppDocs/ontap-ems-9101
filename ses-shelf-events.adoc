...
ALERT
*Description*::
This message occurs when one of the PHY ports of a shelf drawer is reporting an unknown link rate. The PHY port is a physical port in the drawer of the storage shelf that connects to drives on that shelf.
*Corrective Action*::
