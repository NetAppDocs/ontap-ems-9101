...
NOTICE
*Description*::
SnapMirror relationships of type DP are in the process of being deprecated, leaving relationships of type XDP as supported. In an upcoming release, users will no longer be able to create new relationships of type DP. In subsequent releases, relationships of type DP will no longer function.
*Corrective Action*::
