...
[.lead]
flexcache.autogrow EMS events occur when automatically growing a FlexCache volume fails because the total cluster-wide FlexCache provisioned space exceeds the licensed limit.
